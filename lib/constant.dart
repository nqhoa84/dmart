...
DmConst {
  ...
  static Color textColorForTopBarCredit = Color(0xff91278f);
  static Color colorFavorite = Color(0xff91278f);
  static Color textColorPromotionPrice = Color(0xff91278f);
  ...
  static Color homePromotionColor = Color(0xff91278f);

  static Color productShadowColor = Color(0xff91278f);
