...
class DateSlot extends IdObj {
  ...
  String? description = '';
  bool? is1slotOK = false;
  bool? is2slotOK = false;
  bool? is3slotOK = false;
  bool? is4slotOK = false;
  bool? is5slotOK = false;
  bool? is6slotOK = false;
  DateSlot({
    this.deliveryDate,
    this.description,
    this.is1slotOK,
  ...
  DateSlot.fromJSON(Map<String, dynamic> jsonMap) {
    try {
      id = toInt(jsonMap['id']);
      deliveryDate =
          toDateTime(jsonMap['delivery_date'], format: DmConst.dateTimeFormat)!;
      if (deliveryDate == null) {
        deliveryDate =
            toDateTime(jsonMap['delivery_date'], format: DmConst.dateFormat)!;
      }
