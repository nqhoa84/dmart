...
class DmBottomNavigationBar extends StatelessWidget {
  ...
  DmBottomNavigationBar({this.currentIndex, this.onTap, Key? key})
      : super(key: key) {
...
//          ImageIcon( new AssetImage("assets/img/F_Home.png")),
            icon: currentIndex == 0
                ? Image.asset('assets/img/F_Home_01.png',
                    width: size, fit: BoxFit.scaleDown)
                : Image.asset('assets/img/F_Home.png',
                    width: size, fit: BoxFit.scaleDown),
            // label: new Container(height: 0.0),
          ),
          BottomNavigationBarItem(
            icon: currentIndex == 1
                ? Image.asset("assets/img/F_Categories_01.png",
                    width: size, fit: BoxFit.scaleDown)
                : Image.asset("assets/img/F_Categories.png",
                    width: size, fit: BoxFit.scaleDown),
            // label: new Container(height: 0.0),
          ),
          BottomNavigationBarItem(
            icon: currentIndex == 2
                ? Image.asset("assets/img/F_Promotion_01.png",
                    width: size * 1.15, fit: BoxFit.scaleDown)
                : Image.asset("assets/img/F_Promotion.png",
                    width: size * 1.15, fit: BoxFit.scaleDown),
            // label: new Container(height: 0.0),
          ),
          BottomNavigationBarItem(
            icon: currentIndex == 3
                ? Image.asset("assets/img/F_Notificaiton_01.png",
                    width: size, fit: BoxFit.scaleDown)
                : Image.asset("assets/img/F_Notificaiton.png",
                    width: size, fit: BoxFit.scaleDown),
            // label: new Container(height: 0.0),
          ),
          BottomNavigationBarItem(
            icon: currentIndex == 4
                ? Image.asset("assets/img/F_Menu_01.png",
                    width: size, fit: BoxFit.scaleDown)
                : Image.asset("assets/img/F_Menu.png",
                    width: size, fit: BoxFit.scaleDown),
            // label: new Container(height: 0.0),
          ),
        ],
